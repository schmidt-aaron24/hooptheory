...
const PLAYERS_RAW = [
  ...
  ["Billy Cunningham","Philadelphia 76ers","PHI","1960s","SF|PF",19.2,10.2,3.8,1.2,0.6],
  ...
  ["Bob Dandridge","Milwaukee Bucks","MIL","1970s","SF|PF",17.6,6.8,3.2,1.3,0.6],
  ...
  ["Dave Cowens","Boston Celtics","BOS","1970s","C|PF",18.9,14.8,3.9,0.8,0.8],
  ...
  ["George McGinnis","Philadelphia 76ers","PHI","1970s","PF|SF",18.6,10.2,3.8,1.8,0.8],
  ...
  ["George Gervin","San Antonio Spurs","SAS","1970s","SG|SF",27.4,4.8,2.7,1.3,0.7],
  ...
  ["Dan Issel","Denver Nuggets","DEN","1970s","C|PF",21.8,9.5,2.8,0.8,0.5],
  ...
  ["Wes Unseld","Washington Wizards","WAS","1970s","C",11.2,14.8,3.1,0.8,0.5],
  ["Pete Maravich","Utah Jazz","UTA","1970s","PG|SG",25.2,3.8,4.8,1.3,0.2],
  ...
  ["Mel Daniels","Indiana Pacers","IND","1970s","C|PF",19.0,16.2,2.9,0.8,0.9],
  ...
  ["Scottie Pippen","Chicago Bulls","CHI","1980s","SF|PF|SG",16.8,7.2,5.2,2.1,0.8],
  ...
  ["James Worthy","Los Angeles Lakers","LAL","1980s","SF|PF",19.6,5.4,2.8,1.3,0.8],
  ...
  ["Bill Laimbeer","Detroit Pistons","DET","1980s","C|PF",13.2,11.8,2.2,0.6,0.8],
  ...
  ["Otis Thorpe","Houston Rockets","HOU","1980s","PF|C",18.1,10.2,2.4,0.9,0.9],
  ...
  ["Karl Malone","Utah Jazz","UTA","1980s","PF|C",25.8,10.2,2.8,1.3,0.8],
  ...
  ["Buck Williams","Portland Trail Blazers","POR","1980s","PF|C",12.8,10.0,1.7,0.9,0.8],
  ...
  ["George Gervin","San Antonio Spurs","SAS","1980s","SG|SF",28.8,5.0,2.8,1.3,0.7],
  ...
  ["Scottie Pippen","Chicago Bulls","CHI","1990s","SF|PF|SG",18.8,7.8,5.4,2.2,0.8],
  ["Dennis Rodman","Chicago Bulls","CHI","1990s","PF|SF",5.8,17.3,2.1,0.6,0.3],
  ...
  ["Sam Perkins","Oklahoma City Thunder","OKC","1990s","PF|C",13.3,6.9,1.8,0.7,0.8],
  ...
  ["Karl Malone","Utah Jazz","UTA","1990s","PF|C",27.2,10.4,3.8,1.4,0.8],
  ...
  ["Larry Johnson","New York Knicks","NYK","1990s","PF|SF",16.2,6.2,2.8,0.9,0.5],
  ...
  ["Kobe Bryant","Los Angeles Lakers","LAL","2000s","SG|SF",27.9,5.4,4.2,1.6,0.4],
  ...
  ["LeBron James","Cleveland Cavaliers","CLE","2000s","PG|SG|SF|PF",27.8,7.2,7.6,1.7,0.7],
  ...
  ["Manu Ginobili","San Antonio Spurs","SAS","2000s","SG|PG",16.4,3.8,4.2,1.4,0.3],
  ["Bruce Bowen","San Antonio Spurs","SAS","2000s","SF|SG",8.5,3.3,1.4,1.7,0.4],
  ["Robert Horry","San Antonio Spurs","SAS","2000s","PF|SF",6.4,5.2,2.0,0.9,0.7],
  ...
  ["Tracy McGrady","Orlando Magic","ORL","2000s","SG|SF",28.4,6.8,5.2,1.6,1.0],
  ["Grant Hill","Orlando Magic","ORL","2000s","SF|SG",19.7,6.5,5.4,1.1,0.6],
  ...
  ["Carmelo Anthony","Denver Nuggets","DEN","2000s","SF|PF",26.8,5.8,2.8,1.0,0.4],
  ...
  ["James Harden","Oklahoma City Thunder","OKC","2010s","SG|PG",17.0,4.0,3.7,1.0,0.5],
  ["Serge Ibaka","Oklahoma City Thunder","OKC","2010s","PF|C",15.9,7.2,1.0,0.6,3.7],
  ["Paul George","Oklahoma City Thunder","OKC","2010s","SF|SG",28.0,8.2,4.1,2.2,0.4],
  ["Stephen Curry","Golden State Warriors","GSW","2010s","PG|SG",28.4,5.0,6.4,2.0,0.2],
  ["Kevin Durant","Golden State Warriors","GSW","2010s","SF|PF",24.2,6.6,4.8,1.0,1.0],
  ["Klay Thompson","Golden State Warriors","GSW","2010s","SG|SF",20.2,3.6,2.0,0.9,0.5],
  ["Draymond Green","Golden State Warriors","GSW","2010s","PF|C|SF",9.8,7.4,6.8,1.5,1.1],
  ["Andre Iguodala","Golden State Warriors","GSW","2010s","SF|SG",7.6,4.3,4.0,1.4,0.5],
  ...
  ["Brook Lopez","Milwaukee Bucks","MIL","2010s","C",12.5,4.9,2.2,0.6,1.8],
  ...
  ["Kawhi Leonard","San Antonio Spurs","SAS","2010s","SF|PF",22.4,6.0,2.4,2.0,0.7],
  ...
  ["Kyrie Irving","Cleveland Cavaliers","CLE","2010s","PG|SG",22.4,3.4,5.2,1.3,0.3],
  ["Kevin Love","Cleveland Cavaliers","CLE","2010s","PF|C",17.2,10.2,2.2,0.6,0.5],
  ["J.R. Smith","Cleveland Cavaliers","CLE","2010s","SG|SF",12.7,3.3,2.2,0.9,0.2],
  ["Tristan Thompson","Cleveland Cavaliers","CLE","2010s","C|PF",8.5,10.6,0.8,0.5,0.5],
  ["Luka Dončić","Dallas Mavericks","DAL","2010s","PG|SG|SF",21.2,7.8,6.0,1.1,0.3],
  ...
  ["LaMarcus Aldridge","Portland Trail Blazers","POR","2010s","PF|C",21.8,9.4,2.0,0.6,0.9],
  ...
  ["Nikola Jokić","Denver Nuggets","DEN","2020s","C|PF",26.4,12.4,8.2,1.3,0.7],
  ["Jamal Murray","Denver Nuggets","DEN","2020s","PG|SG",19.8,3.8,5.8,1.0,0.3],
  ["Michael Porter Jr.","Denver Nuggets","DEN","2020s","SF|PF",20.6,7.3,1.7,0.7,0.6],
  ["Aaron Gordon","Denver Nuggets","DEN","2020s","PF|SF",13.9,6.5,3.5,0.9,0.6],
  ...
  ["Derrick Jones Jr.","Dallas Mavericks","DAL","2020s","SF|PF",9.5,4.2,1.2,1.2,0.6],
  ...
  ["Jayson Tatum","Boston Celtics","BOS","2020s","SF|PF",27.2,8.2,4.6,1.1,0.6],
  ...
  ["Shai Gilgeous-Alexander","Oklahoma City Thunder","OKC","2020s","PG|SG",30.2,5.2,5.8,1.9,0.9],
  ...
  ["Karl-Anthony Towns","Minnesota Timberwolves","MIN","2020s","C|PF",21.9,8.5,3.0,0.7,0.7],
  ...
  ["Victor Wembanyama","San Antonio Spurs","SAS","2020s","C|PF",25.0,11.5,3.1,1.0,3.1],
  ...
  ["Draymond Green","Golden State Warriors","GSW","2020s","PF|C|SF",8.5,7.3,6.8,1.3,0.8],
  ["Andrew Wiggins","Golden State Warriors","GSW","2020s","SF|SG",17.1,4.5,2.4,0.9,0.6],
  ...
  ["Bob McAdoo","Los Angeles Lakers","LAL","1980s","C|PF",12.3,5.7,1.5,0.5,0.8],
  ...
  ["Anderson Varejao","Cleveland Cavaliers","CLE","2000s","C|PF",7.4,8.4,1.4,0.8,0.8],
  ...
  ["DeAndre Jordan","Denver Nuggets","DEN","2020s","C",6.4,8.2,1.2,0.4,0.8],
  ...
  ["James Harden","Indiana Pacers","IND","2020s","SG|PG",20.8,5.8,8.6,1.1,0.5],
  ...
  ["Terry Cummings","San Antonio Spurs","SAS","1990s","PF|SF",14.4,6.8,1.8,0.8,0.6],
  ...
  ["Michael Carter-Williams","Milwaukee Bucks","MIL","2010s","PG|SG",12.4,5.2,5.8,2.0,0.8],
  ...
  ["Dwight Powell","Dallas Mavericks","DAL","2010s","C|PF",9.4,5.8,1.4,0.6,0.8],
  ...
  ["George McGinnis","Indiana Pacers","IND","1970s","PF|SF",25.8,13.4,4.8,2.0,0.8],
  ...
  ["Kevin McHale","Houston Rockets","HOU","2010s","PF|C",8.4,5.2,1.2,0.4,0.8],
  ...
  ["Anderson Varejao","Cleveland Cavaliers","CLE","2010s","C|PF",8.4,10.4,1.8,0.8,0.8],
  ...
  ["Matisse Thybulle","Philadelphia 76ers","PHI","2020s","SG|SF",6.4,2.8,1.4,1.8,0.8],
  ...
  ["Derrick White","Boston Celtics","BOS","2020s","PG|SG",12.4,4.2,4.2,1.2,1.0],
  ...
  ["Marvin Bagley III","Sacramento Kings","SAC","2020s","PF|C",13.8,7.4,1.2,0.4,0.8],
  ...
  ["Jerami Grant","Oklahoma City Thunder","OKC","2010s","PF|SF",9.2,3.8,1.4,0.8,0.8],
  ...
  ["David West","San Antonio Spurs","SAS","2010s","PF|C",8.4,5.4,2.8,0.8,0.6],
  ["Kyle Anderson","San Antonio Spurs","SAS","2010s","SF|PF",9.4,4.8,3.2,1.0,0.6],
  ["Dejounte Murray","San Antonio Spurs","SAS","2010s","PG",11.4,5.4,4.2,1.8,0.4],
  ...
  ["John Collins","Atlanta Hawks","ATL","2020s","PF|C",15.4,7.8,2.0,0.8,0.8],
  ...
  ["Larry Nance Jr.","Atlanta Hawks","ATL","2020s","PF|SF",8.4,6.4,2.4,1.0,0.8],
  ...
  ["Jayson Tatum","Boston Celtics","BOS","2010s","SF|PF",18.8,6.4,2.8,1.0,0.6],
  ...
  ["Buck Williams","Brooklyn Nets","BKN","1980s","PF|C",16.8,12.4,1.8,1.0,0.8],
  ...
  ["Derrick Coleman","Brooklyn Nets","BKN","1990s","PF|C",19.8,10.4,3.4,1.2,0.8],
  ...
  ["DeAndre Jordan","Brooklyn Nets","BKN","2010s","C",8.4,11.4,1.4,0.4,0.8],
  ...
  ["Al Jefferson","Charlotte Hornets","CHA","2010s","C|PF",18.4,9.4,1.4,0.6,0.8],
  ["Dwight Howard","Charlotte Hornets","CHA","2010s","C",14.4,12.4,1.8,0.8,1.8],
  ["Jeremy Lamb","Charlotte Hornets","CHA","2010s","SG|SF",14.4,4.8,2.4,1.0,0.6],
  ...
  ["Miles Bridges","Charlotte Hornets","CHA","2020s","SF|PF",20.2,7.0,3.8,1.2,0.6],
  ...
  ["Nikola Vucevic","Chicago Bulls","CHI","2020s","C|PF",17.4,11.4,3.4,0.8,0.8],
  ...
  ["Donovan Mitchell","Cleveland Cavaliers","CLE","2020s","SG|PG",28.4,4.4,5.4,1.4,0.4],
  ...
  ["Kenneth Faried","Denver Nuggets","DEN","2010s","PF|C",13.4,9.4,1.4,0.8,0.8],
  ["Ty Lawson","Denver Nuggets","DEN","2010s","PG",16.4,3.4,8.4,1.4,0.2],
  ["Nikola Jokic","Denver Nuggets","DEN","2010s","C|PF",21.4,10.6,6.4,1.2,0.8],
  ...
  ["Grant Hill","Detroit Pistons","DET","1990s","SF|SG",21.6,7.9,6.3,1.8,0.6],
  ...
  ["Blake Griffin","Detroit Pistons","DET","2010s","PF|C",20.4,7.4,4.4,0.8,0.6],
  ...
  ["Paul George","Indiana Pacers","IND","2010s","SF|SG",22.4,6.4,3.8,1.8,0.4],
  ["Roy Hibbert","Indiana Pacers","IND","2010s","C",11.4,7.4,1.4,0.6,2.2],
  ["David West","Indiana Pacers","IND","2010s","PF|C",13.4,6.4,2.8,1.0,0.6],
  ...
  ["Blake Griffin","Los Angeles Clippers","LAC","2010s","PF|C",23.4,9.4,4.4,1.0,0.6],
  ...
  ["Paul George","Los Angeles Clippers","LAC","2010s","SF|SG",24.4,6.4,4.4,2.2,0.4],
  ...
  ["Paul George","Los Angeles Clippers","LAC","2020s","SF|SG",21.4,5.4,5.4,1.8,0.4],
  ...
  ["Metta World Peace","Los Angeles Lakers","LAL","2010s","SF|SG",9.4,3.4,2.4,1.4,0.4],
  ...
  ["Jaren Jackson Jr.","Memphis Grizzlies","MEM","2010s","PF|C",16.4,5.4,1.8,1.0,3.4],
  ["Jonas Valanciunas","Memphis Grizzlies","MEM","2010s","C",16.4,10.4,2.4,0.8,0.8],
  ...
  ["Bam Adebayo","Miami Heat","MIA","2020s","C|PF",19.4,10.4,3.4,1.2,0.8],
  ...
  ["Kevin Love","Miami Heat","MIA","2020s","PF|C",10.4,6.4,2.4,0.6,0.4],
  ...
  ["Bob Dandridge","Milwaukee Bucks","MIL","1960s","SF|PF",16.8,7.0,3.2,1.3,0.6],
  ...
  ["Jack Sikma","Milwaukee Bucks","MIL","1980s","C",14.4,8.4,4.4,1.4,0.8],
  ...
  ["Zion Williamson","New Orleans Pelicans","NOP","2020s","PF|C",25.4,7.4,4.4,1.2,0.6],
  ...
  ["Jonas Valanciunas","New Orleans Pelicans","NOP","2020s","C",14.4,12.4,2.4,0.6,0.8],
  ...
  ["Larry Nance Jr.","New Orleans Pelicans","NOP","2020s","PF|SF",8.4,6.4,2.4,1.2,0.8],
  ...
  ["Carmelo Anthony","New York Knicks","NYK","2010s","SF|PF",24.4,6.4,2.4,0.8,0.4],
  ["Amar'e Stoudemire","New York Knicks","NYK","2010s","PF|C",21.4,9.4,1.8,0.6,0.8],
  ["Kristaps Porzingis","New York Knicks","NYK","2010s","C|PF",18.4,7.4,1.8,0.8,2.4],
  ["Tyson Chandler","New York Knicks","NYK","2010s","C",7.4,11.4,1.4,0.6,0.8],
  ...
  ["Joakim Noah","New York Knicks","NYK","2010s","C",7.4,8.4,4.4,0.8,0.8],
  ...
  ["Julius Randle","New York Knicks","NYK","2020s","PF|C",22.4,10.4,5.4,0.8,0.4],
  ...
  ["OG Anunoby","New York Knicks","NYK","2020s","SF|SG",14.4,5.4,2.4,1.8,0.6],
  ...
  ["Jack Sikma","Oklahoma City Thunder","OKC","1970s","C",16.4,11.4,3.4,1.4,0.8],
  ...
  ["Jack Sikma","Oklahoma City Thunder","OKC","1980s","C",16.4,9.4,3.4,1.4,0.8],
  ...
  ["Earl Watson","Oklahoma City Thunder","OKC","2000s","PG",8.4,3.4,5.4,1.4,0.2],
                                                              ["Nikola Vucevic","Orlando Magic","ORL","2010s","C|PF",18.4,10.4,3.4,0.8,0.8],
  ...
  ["Aaron Gordon","Orlando Magic","ORL","2010s","PF|SF",14.4,7.4,3.4,1.0,0.6],
  ...
  ["Paolo Banchero","Orlando Magic","ORL","2020s","PF|SF",22.4,6.4,4.4,0.8,0.4],
  ...
  ["Charles Barkley","Philadelphia 76ers","PHI","1990s","PF|C",24.4,11.4,3.4,1.4,0.6],
  ...
  ["Clarence Weatherspoon","Philadelphia 76ers","PHI","1990s","PF|SF",14.4,8.4,2.4,1.0,0.8],
  ["Derrick Coleman","Philadelphia 76ers","PHI","1990s","PF|C",17.4,9.4,3.4,1.2,0.8],
  ...
  ["Amir Johnson","Philadelphia 76ers","PHI","2010s","PF|C",9.4,6.4,1.8,0.8,0.8],
  ...
  ["Matisse Thybulle","Portland Trail Blazers","POR","2020s","SG|SF",7.4,3.4,1.8,2.0,0.8],
  ...
  ["Pascal Siakam","Toronto Raptors","TOR","2010s","PF|SF",20.4,7.4,3.4,1.0,0.6],
  ...
  ["OG Anunoby","Toronto Raptors","TOR","2010s","SF|SG",10.4,5.4,1.8,1.8,0.6],
  ...
  ["Scottie Barnes","Toronto Raptors","TOR","2020s","SF|PF",17.4,7.4,5.4,1.4,0.8],
  ["Pascal Siakam","Toronto Raptors","TOR","2020s","PF|SF",23.4,8.4,5.4,1.2,0.6],
  ["OG Anunoby","Toronto Raptors","TOR","2020s","SF|SG",16.4,5.4,2.4,1.8,0.6],
  ...
  ["Lauri Markkanen","Utah Jazz","UTA","2020s","PF|C",23.4,8.4,2.4,0.8,0.6],
  ...
  ["Marcin Gortat","Washington Wizards","WAS","2010s","C",10.4,9.4,1.4,0.6,0.8],
  ...
  ["LaMarcus Aldridge","Brooklyn Nets","BKN","2020s","C|PF",12.4,6.4,1.8,0.6,1.0],
  ["Paul Millsap","Brooklyn Nets","BKN","2020s","PF|C",8.4,5.4,1.8,0.8,0.6],
  ...
  ["Derrick Jones Jr.","Chicago Bulls","CHI","2020s","SF|PF",7.4,4.4,1.4,1.0,0.6],
  ...
  ["Larry Nance Jr.","Los Angeles Lakers","LAL","2010s","PF|C",8.4,6.4,2.4,1.2,0.8],
  ...
  ["Kenyon Martin","New York Knicks","NYK","2010s","PF|C",9.4,5.4,1.4,0.8,0.6],
  ...
  ["Tyson Chandler","Phoenix Suns","PHX","2010s","C",8.4,10.4,1.4,0.6,0.8],
  ...
  ["Donovan Mitchell","Utah Jazz","UTA","2020s","SG|PG",26.4,4.4,5.4,1.4,0.4],
...
const UNCOMMON_FRANCHISES = new Set(["Washington Wizards|1960s",
  ...
  "Oklahoma City Thunder|1990s","Orlando Magic|1990s","Indiana Pacers|1990s","New York Knicks|1990s",
